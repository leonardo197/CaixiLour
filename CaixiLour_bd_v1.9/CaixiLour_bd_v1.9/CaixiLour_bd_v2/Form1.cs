    ...
    public partial class Form1 : Form
    {
       ...
       // SqlCommandBuilder cmdBldr;
        ...
        private void b_pes_complemetos_Click(object sender, EventArgs e)
        {
            ...
            //if (tb_pes_complemetos.Text == "" && cb_cor_complementos.Items.Count == 0 && Convert.ToString(SB_preco.Value) == "0")//caso de def
            //{}
            //else
            //{
        ...
        private void b_pes_estores_Click(object sender, EventArgs e)
        {
            ...
            //if (tb_pes_estores.Text == "" && cb_cor_estores.Items.Count == 0 && Convert.ToString(SB_preco.Value) == "0")//caso de def
            //{ }
            //else
            //{
                pes_tb();//pes se tiver serto
        ...
        private void b_pes_puxadores_Click(object sender, EventArgs e)
        {
            ...
            //if (tb_pes_puxadores.Text == "" && cb_cor_puxadores.Items.Count == 0 && Convert.ToString(SB_preco.Value) == "0")//caso de def
           // { }
            //else
            //{
                pes_tb();//pes se tiver serto
        ...
        private void panel_menu_Paint(object sender, PaintEventArgs e)
        {
            ...
            // panel_menu.Bounds = this.RectangleToScreen(r);
        ...
        {
            //rb_portas_vidro_nao.Checked = true;
            //if (rb_portas_grlha_nao.Checked != true)
            //{
            //  rb_portas_grlha_nao.Checked = true; 
            //}     
        }
        private void rb_portas_grlha_sim_CheckedChanged(object sender, EventArgs e)
        {
            //rb_portas_grlha_sim.Checked = true;
            //if (rb_portas_vidro_sim.Checked != true)
            //{
            //    rb_portas_vidro_sim.Checked = true;
            //}
        ...
        private void lb_preco_total_Click(object sender, EventArgs e)
        {
