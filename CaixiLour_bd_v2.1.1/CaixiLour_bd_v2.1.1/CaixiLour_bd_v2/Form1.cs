...
cnn = new SqlConnection("Data Source=192.168.3.13,1433; Network Library=DBMSSOCN;Initial Catalog=caixilour_estoque; User ID=admin;Password=caixilour");
        ...
        public void pes_estores()
        {
            ...
            if (tb_pes_estores.Text == "" && cb_cor_estores.Items.Count != 0 && Convert.ToString(SB_preco.Value) == "0" && cb_cor_portas.Text != "TODAS")//pes por cor
            {
            ...
            if (tb_pes_estores.Text == "" && cb_cor_estores.Items.Count != 0 && Convert.ToString(SB_preco.Value) != "0" && cb_cor_portas.Text != "TODAS")//pes por preço e cor
            {
        ...
        public void pes_puxadores()
            ...
            if (tb_pes_puxadores.Text == "" && cb_cor_puxadores.Items.Count != 0 && Convert.ToString(SB_preco.Value) == "0" && cb_cor_portas.Text != "TODAS")//pes por cor
            {
            ...
            if (tb_pes_puxadores.Text == "" && cb_cor_puxadores.Items.Count != 0 && Convert.ToString(SB_preco.Value) != "0" && cb_cor_portas.Text != "TODAS")//pes por preço e cor
            {
        ...
        public void pes_complementos()
        {
            ...
            if (tb_pes_complemetos.Text == "" && cb_cor_complementos.Items.Count != 0 && Convert.ToString(SB_preco.Value) == "0" && cb_cor_portas.Text != "TODAS")//pes por cor
            {
                sql_string = "select * from complementos where Cor ='" + (cb_cor_complementos.Text) + "'";
            }
            if (tb_pes_complemetos.Text != "" && cb_cor_complementos.Items.Count == 0 && Convert.ToString(SB_preco.Value) == "0"&& cb_cor_portas.Text!="TODAS")//pes por ref
            {
                sql_string = "select * from complementos where Referência ='" + (tb_pes_complemetos.Text) + "'";
            }
            if (tb_pes_complemetos.Text == "" && cb_cor_complementos.Items.Count == 0 && Convert.ToString(SB_preco.Value) != "0" && cb_cor_portas.Text != "TODAS")//pes por preço
            {
                sql_string = "select * from complementos where preço <='" + (Convert.ToString(SB_preco.Value)) + "'";
            }
            if (tb_pes_complemetos.Text == "" && cb_cor_complementos.Items.Count != 0 && Convert.ToString(SB_preco.Value) != "0" && cb_cor_portas.Text != "TODAS")//pes por preço e cor
            {
