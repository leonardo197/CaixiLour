        ...
        {           
         ...
         string sql_string;
           ...
           pb_foto_6.BackgroundImage = null;
            ...
            //caso erro de ligua
           if (CAIXIOUR.st=="Assistências")
           {
               sql_string = "select * from Assistencias where ID_" + CAIXIOUR.st + "='" + CAIXIOUR.id + "'"; 
           }
           else
           {
           sql_string = "select * from " + CAIXIOUR.st + " where ID_" + CAIXIOUR.st + "='" + CAIXIOUR.id + "'";
           }
           //ligar tab
